...
class PageAccess (Model):
    ...
    name = CharField(max_length=255, verbose_name="Nom de la règle d’accès")
    ...
    title = CharField(verbose_name="Titre de la fenêtre",
                      help_text="Titre affiché sur la fenêtre empêchant l’accès à la page.", default="Vous êtes en avance (ou en retard) !", max_length=255)
