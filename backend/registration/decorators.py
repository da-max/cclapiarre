...
def application_permissions_required(group_type="admins"):
    ...
    """
    def decorator(func):
        def wrapper(root, info, application__slug, *args, **kwargs):
            user = info.context.user
            try:
                app = Application.objects.get(slug=application__slug)
            ...
            return func(root, info, application__slug, *args, **kwargs)
