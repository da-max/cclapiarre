...
class Query(application_query, article_query, carousel_query, coffee_query, event_query,
            registration_query, ObjectType):
    pass


class Mutation(application_mutation, article_mutation, coffee_mutation, registration_mutation, ObjectType):
