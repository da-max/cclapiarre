...
class UpdateCarousel(PermissionRequiredMixin, LoginRequiredMixin, UpdateView):
    ...
    def form_invalid(self, form):
        messages.warning(self.request, "Votre carousel n'a pas pu être enregistré, merci de réessayer.")
...
def delete_carousel(request, id_carousel):
    ...
    if result:
        ...
        messages.warning(request, "Le carousel n'a pas pu être supprimé, merci de réessayer.")
