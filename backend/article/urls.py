...
from backend.article.views import home, CreateArticle, delete_article, UpdateArticle, ListArticle
...
urlpatterns = [
	...
	path("supprimer-un-article/<int:id_article>", delete_article, name="delete_article"),
