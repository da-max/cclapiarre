...
from backend.citrus.models import Amount, Product, Command
from backend.coffee.models import Coffee, CommandCoffee, Quantity as AmountCoffee, Origin as OriginCoffee, Type as TypeCoffee
